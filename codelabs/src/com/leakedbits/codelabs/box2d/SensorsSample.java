...
import com.leakedbits.codelabs.utils.PolygonManager;
import com.leakedbits.codelabs.utils.Sample;
import com.leakedbits.codelabs.utils.Tuple;
...
//		bodyDef.fixedRotation = true;
	...
	public void beginContact(Contact contact) {
		...
		if (fixtureA.isSensor()
			...
			Gdx.app.log("Sensors", "FixtureB getting wet");
			...
			Gdx.app.log("Sensors", "FixtureA getting wet");
	...
	public void endContact(Contact contact) {
		...
		if (fixtureA.isSensor()
				&& fixtureB.getBody().getType() == BodyType.DynamicBody) {
			Gdx.app.log("Sensors", "FixtureB not wet anymore");
			...
			if (fixtureA.getBody().getWorldCenter().y > -1) {
				...
				Gdx.app.log("Sensors", "FixtureA not wet anymore");
	...
	public void applyBuoyancy() {
		for (Tuple<Fixture, Fixture> tuple : wetBodies) {
			...
			if (PolygonManager.findIntersectionOfFixtures(fixtureA, fixtureB,
					intersectionPoints)) {

				// find centroid
				float area = 0;
				Vector2 centroid = PolygonManager.ComputeCentroid(
						intersectionPoints, area);
				...
				Gdx.app.log("SENSORS", "Not clipping");
			}
		}
	}
}
